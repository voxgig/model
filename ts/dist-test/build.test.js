...
(0, node_test_1.describe)('build', () => {
    (0, node_test_1.test)('project-p01', async () => {
        ...
        let b0 = (0, build_1.makeBuild)({
            ...
            path: __dirname + '/../test/p01/model/model.aon',
            res: [
                {
                    path: '/',
...
<p>BAR: 2</p>
    ...
    (0, node_test_1.test)('project-sys01', async () => {
        ...
        await (0, promises_1.writeFile)(folder + 'model/pre.aon', 'BAD');
        ...
        node_assert_1.default.strictEqual((0, node_fs_1.readFileSync)(folder + 'model/pre.aon').toString(), 'BAD');
