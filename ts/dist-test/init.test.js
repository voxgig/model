...
(0, node_test_1.describe)('init', () => {
    (0, node_test_1.test)('scaffolds-and-skips-existing', async () => {
        ...
        await (0, promises_1.stat)(dir + '/model/model.aon');
        await (0, promises_1.stat)(dir + '/model/.model-config/model-config.aon');
    ...
    (0, node_test_1.test)('scaffold-builds', async () => {
        ...
        const model = new model_1.Model({
            path: dir + '/model/model.aon', base: dir + '/model', debug: 'silent',
        });
