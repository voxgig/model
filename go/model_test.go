...
func TestModelRun(t *testing.T) {
	dir := t.TempDir()
	writeFile(t, dir, "m.aon", "service: { name: 'orders', port: *8080 | integer }\n")
...
func TestWatchRebuild(t *testing.T) {
	dir := t.TempDir()
	writeFile(t, dir, "m.aon", "val: @\"./zed.aon\"\n")
	writeFile(t, dir, "zed.aon", "2")
